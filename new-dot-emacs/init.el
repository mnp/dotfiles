...
(custom-set-variables
 ...
 '(package-selected-packages
   '(agent-shell amber-glow-theme browse-kill-ring claude-code deft dockerfile-mode dot-mode elfeed
		 elfeed-summary embark gruvbox-theme highlight-indent-guides highlight-indentation
		 iedit indent-bars json-navigator kele lsp-ui message-view-patch orderless
