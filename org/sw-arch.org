* OTA
https://www.zerynth.com/blog/firmware-over-the-air-updates-via-aws-powered-by-zerynth/
https://mender.io/
I like guix for atomic upgrades, maybe not for production though - it's Guile all the way down
...
* async comm channels
** http up, mqtt down - because api gateway
